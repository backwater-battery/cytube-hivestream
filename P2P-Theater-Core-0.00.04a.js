...
// CHANGELOG v0.00.04
// ─────────────────────────────────────────────────────────────
// FIX: b64 decode — '-' sentinel no longer passed to atob()
// FIX: Large magnet no-webseed ghost IDLE→PLAYING removed
// FIX: archivePick stray transition('PLAYING') removed
// NEW: Codec/HEVC detection before playback attempt
// NEW: !hs peers / peers button — wire detail in chat
// HUD: shows 🔗 WebRTC peers vs 🌐 webseed peers separately
// ============================================================
(function(){
'use strict';
