...
// CHANGELOG v0.00.08
// ─────────────────────────────────────────────────────────────
// DATA: Tracker and STUN lists rebuilt from real mobile tests
//       run on Samsung S23FE on carrier data (no VPN).
//       Tests: hivestream-ice-stun-latency-ranker.sh,
//              hivestream-wss-ws-tracker-speedrank.sh
//
// FIX: Tracker list — confirmed working (HTTP 101) promoted:
//        wss://tracker.openwebtorrent.com  101 ✓ 501ms
//        wss://tracker.novage.com.ua       101 ✓ 891ms
//        wss://tracker.files.fm:7073       101 ✓ 949ms
//      Dead trackers removed (HTTP 000):
//        tracker.webtorrent.dev, tracker.webtorrent.io,
//        tracker.fastcast.nz, wstracker.online
//      Path fixed: tracker.btorrent.xyz now uses /announce
//        (was returning 403 due to missing path)
//      Plain ws:// entries removed (carrier blocks port 80 WS)
//
// FIX: ICE/STUN servers — rebuilt from latency ranker results:
//        stun.cloudflare.com:3478   114ms ✓ (moved to top)
//        stun.l.google.com:19302    155ms ✓
//        stun.nextcloud.com:443     272ms ✓ (port 443 = firewall-friendly)
//      Removed: stun.twilio.com (FAIL), stun.ekiga.net (untested)
//
// NOTE: NAT type confirmed as cone (not symmetric) from STUN
//       mapped address consistency. WebRTC hole-punch should
//       succeed between peers once tracker peer exchange works.
//
// CARRY: All fixes from v0.00.07 and earlier.
// ============================================================
(function(){
'use strict';
